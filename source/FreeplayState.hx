...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			leSongs.push(leWeek.songs[i][0]);
			leChars.push(leWeek.songs[i][1]);
		}
		...
		scoreText.setFormat(Paths.font("tomgles.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		text.setFormat(Paths.font("tomgles.ttf"), size, FlxColor.WHITE, RIGHT);
